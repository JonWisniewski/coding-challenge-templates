...
public class SupervisorController {
	...
	/**
	 * Endpoint that calls api/supervisors as a GET function to gather all the
	 * supervisors and arrange them in order by jurisdiction -> last name -> first
	 * name. After that, the supervisors are filtered out if the jurisdiction
	 * contains a number.
	 * 
	 * @return responseEntity<List<String>> returns 200 status if successful, and
	 *         returns a responseBody of supervisors
	 */
	...
	/**
	 * Endpoint that calls api/submit as a POST function to submit personal
	 * information
	 * 
